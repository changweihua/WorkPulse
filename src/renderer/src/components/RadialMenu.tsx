    ...
    >
          ...
          >
            <defs>
              <linearGradient id="segGlass" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="rgba(40,40,42,0.85)" />
                <stop offset="100%" stopColor="rgba(40,40,42,0.65)" />
              </linearGradient>
            </defs>
            {ITEMS.map((item, i) => {
      ...
      >
        ...
        <motion.img
          ...
          style={{ width: 44, height: 44, objectFit: 'contain' } as React.CSSProperties}
          initial={{ opacity: 1 }}
