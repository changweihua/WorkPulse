...
export default function FeedSidebar() {
  const {
    ...
    useShallow((s) => ({
      ...
      editingFeed: s.editingFeed,
      setSelectedFeed: s.setSelectedFeed,
      ...
      setEditingFeed: s.setEditingFeed,
  ...
  const [contextMenu, setContextMenu] = useState<{ feedId: number; x: number; y: number } | null>(
    null,
  );
