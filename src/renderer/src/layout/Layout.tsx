      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-zinc-200/20 dark:border-zinc-700/20">
        <div className="flex items-center gap-1">
          ...
          <nav className="flex gap-1">
            ...
            {navLink(
              'stats',
              <BarChart3 className="inline-block w-4 h-4 mr-1 -mt-0.5" />,
              t('nav.stats'),
            )}
            {navLink(
              'calendar',
            ...
            {navLink(
              'pp',
              <SiPaddlepaddle className="inline-block w-4 h-4 mr-1 -mt-0.5" />,
              t('nav.pp'),
            )}
            {navLink('xray', <Zap className="inline-block w-4 h-4 mr-1 -mt-0.5" />, t('nav.xray'))}
            {navLink(
              'onnx',
              <SiOnnx className="inline-block w-4 h-4 mr-1 -mt-0.5" />,
              t('nav.onnx'),
            )}
            {navLink(
              'ocr',
              <SiPaddle className="inline-block w-4 h-4 mr-1 -mt-0.5" />,
              t('nav.ocr'),
            )}
          </nav>
        </div>
