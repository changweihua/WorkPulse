...
function SettingsPage(): ReactNode {
  ...
  const [reportLanguage, setReportLanguage] = useState(
    resolvedLanguage === 'zh' ? '中文' : 'English',
  );
          ...
          <div className="grid grid-cols-2 gap-4 items-start">
            ...
            <section className="col-span-2 surface-card p-5">
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-zinc-400 mb-2">{t('settings.promptHelp')}</p>
                <textarea
                  value={systemPrompt}
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-zinc-400 mb-2">{t('settings.templateHelp')}</p>
                <textarea
            ...
            <section className="surface-card p-5">
              ...
              <div className="h-px bg-zinc-200/50 dark:bg-zinc-700/50 mb-4" />
              <p className="text-xs text-zinc-400 mb-4">{t('settings.shortcutsHelp')}</p>

              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                    {t('settings.shortcutLog')}
                  </label>
                  <ShortcutCapture
                    value={shortcutLog}
                ...
                <div>
                  <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                    {t('settings.shortcutTask')}
                  </label>
                  <ShortcutCapture
                    value={shortcutTask}
                    onChange={(v) =>
                      handleShortcutChange('shortcut_quick_task', v, setShortcutTask)
                    }
                    capturingLabel={t('settings.capturingShortcut')}
                  />
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mt-0.5">
                    {resolvedLanguage === 'zh'
                      ? '关闭时使用文本精确匹配'
                      : 'Off: use text matching'}
                  </p>
                </div>
                <button
                  onClick={() =>
                    handleSearchModeChange(searchMode === 'vector' ? 'like' : 'vector')
                  }
                ...
                >
                  <span
                    className={`inline-block h-3.5 w-3.5 rounded-full bg-white transition-transform ${searchMode === 'vector' ? 'translate-x-[18px]' : 'translate-x-[2px]'}`}
                  />
                </button>
              </div>
            </section>
                  ...
                  {(
                    [
                      ...
                      },
                      {
                        ...
                        Icon: Monitor,
                        color: 'bg-gradient-to-r from-amber-400 to-zinc-700',
                      },
                    ] as const
                    ...
                    >
                      <span
                        className={`w-2.5 h-2.5 rounded-full ${color} ${theme === value ? 'ring-2 ring-white dark:ring-zinc-900 ring-offset-1' : ''}`}
                      />
                  ...
                  {ACCENTS.map(({ id, color, labelKey }) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full transition-transform hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 ${
                        accent === id
                          ? 'ring-2 ring-blue-600 dark:ring-blue-400 ring-offset-2 ring-offset-white dark:ring-offset-zinc-900 scale-110'
                          : ''
                      }`}
                ...
                <div className="flex gap-2">
                  {(
                    [
                      {
                        value: 'mica',
                        label: t('settings.materialMica'),
                        Icon: Layers,
                        color: 'bg-blue-400',
                      },
                      {
                        value: 'tabbed',
                        label: t('settings.materialTabbed'),
                        Icon: PanelTop,
                        color: 'bg-indigo-400',
                      },
                      {
                        value: 'acrylic',
                        label: t('settings.materialAcrylic'),
                        Icon: Droplets,
                        color: 'bg-cyan-400',
                      },
                    ] as const
                    ...
                    >
                      <span
                        className={`w-2.5 h-2.5 rounded-full ${color} ${material === value ? 'ring-2 ring-white dark:ring-zinc-900 ring-offset-1' : ''}`}
                      />
                      <Icon className="w-4 h-4" />
                      {label}
                    </button>
            ...
            <section className="surface-card p-5">
                ...
                {loadingAutoLaunch ? (
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 ${
                      autoLaunch ? 'bg-blue-500' : 'bg-zinc-300 dark:bg-zinc-600'
                    }`}
                  >
                    <span
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 ${
                      reminderEnabled ? 'bg-blue-500' : 'bg-zinc-300 dark:bg-zinc-600'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 ${
                    dailySummaryEnabled ? 'bg-blue-500' : 'bg-zinc-300 dark:bg-zinc-600'
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <section className="surface-card p-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 ${
                    radialEnabled ? 'bg-blue-500' : 'bg-zinc-300 dark:bg-zinc-600'
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      radialEnabled ? 'translate-x-6' : 'translate-x-1'
                    }`}
                  />
                </button>
              </div>
                ...
                <div className="mt-4 flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                          ...
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs text-zinc-400">
                                #
                                {radialItems.filter((i) => i.type !== 'program').length + index + 1}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              <button
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 mt-2 rounded-lg border border-dashed border-border hover:border-primary hover:bg-primary/5 transition-colors disabled:opacity-50 w-full"
                    >
                      {addingProgram ? (
