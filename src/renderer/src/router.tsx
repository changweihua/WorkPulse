    ...
    return (
        <div className="h-full flex flex-col items-center justify-center gap-3">
            <div className="relative w-[68px] h-[68px] flex items-center justify-center">
                ...
                <div className="absolute -inset-[4px] rounded-full border border-transparent border-b-indigo-300/20 border-l-indigo-400/10 animate-spin" style={{ animationDirection: 'reverse', animationDuration: '2.4s' }} />
                {/* 内部方形 Logo */}
